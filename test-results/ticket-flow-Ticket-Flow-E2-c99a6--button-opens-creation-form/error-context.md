...
- Name: ticket-flow.spec.ts >> Ticket Flow E2E >> new ticket button opens creation form
- Location: e2e\ticket-flow.spec.ts:46:3
...
Call log:
  - waiting for getByRole('button', { name: /nuovo ticket/i })
