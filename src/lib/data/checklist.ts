...
function mapInstance(row: any): TicketChecklistInstanceRow {
  return {
    ...
    responses: (row.responses ?? row.ticket_checklist_responses ?? []) as TicketChecklistResponseRow[],
  };
}
...
// Re-export template mutation helpers for hooks
export { createTemplate, updateTemplate, deleteTemplate, setDefaultTemplate };
