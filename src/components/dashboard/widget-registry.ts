...
export const DASHBOARD_WIDGETS: WidgetEntry[] = [
  {
    ...
    description: i18n.t(
      "dashboard:widgets.stat-cards.desc",
      "Ticket totali, dispositivi, clienti attivi e stati",
    ),
  },
  {
    id: "analytics-card",
    ...
    description: i18n.t(
      "dashboard:widgets.analytics-card.desc",
      "Andamento mensile ticket e performance tecnici",
    ),
  },
  {
    ...
    description: i18n.t(
      "dashboard:widgets.devices-without-ticket.desc",
      "Dispositivi senza ticket attivo",
    ),
  },
  {
    ...
    description: i18n.t(
      "dashboard:widgets.tickets-without-device.desc",
  ...
  },
  {
    ...
    description: i18n.t(
      "dashboard:widgets.trend-chart.desc",
      "Andamento ticket aperti vs asset disponibili",
    ),
  },
  {
    id: "recent-tickets",
    ...
    description: i18n.t(
      "dashboard:widgets.recent-tickets.desc",
      "Elenco degli ultimi ticket creati",
    ),
  },
  {
    ...
    description: i18n.t(
      "dashboard:widgets.status-distribution.desc",
      "Grafico a ciambella della distribuzione stati",
    ),
  },
  {
    ...
    description: i18n.t(
      "dashboard:widgets.technician-heatmap.desc",
      "Mappa di calore chiusure settimanali per tecnico",
    ),
  },
  {
    id: "recent-activity",
    label: i18n.t("dashboard:widgets.recent-activity.label", "Attivita recente"),
    description: i18n.t("dashboard:widgets.recent-activity.desc", "Log delle attivita recenti"),
  },
  {
    id: "overdue-tickets",
  ...
  {
    id: "team-activity",
    label: i18n.t("dashboard:widgets.team-activity.label", "Attivita del team"),
    description: i18n.t("dashboard:widgets.team-activity.desc", "Breakdown per tecnico"),
  },
  {
    id: "technician-stats",
    label: i18n.t("dashboard:widgets.technician-stats.label", "Statistiche tecnici"),
    description: i18n.t(
      "dashboard:widgets.technician-stats.desc",
      "Statistiche complete dei tecnici",
    ),
  },
  {
    id: "critical-events",
    label: i18n.t("dashboard:widgets.critical-events.label", "Eventi critici"),
    description: i18n.t("dashboard:widgets.critical-events.desc", "Eventi critici recenti"),
  },
  {
    id: "warranty-overview",
    label: i18n.t("dashboard:widgets.warranty-overview.label", "Garanzie"),
    description: i18n.t(
      "dashboard:widgets.warranty-overview.desc",
      "Stati garanzia e scadenze prossime",
    ),
  },
  {
    ...
    description: i18n.t(
      "dashboard:widgets.maintenance-overview.desc",
      "Prossimi interventi e manutenzioni scadute",
    ),
  },
  {
    ...
    description: i18n.t(
      "dashboard:widgets.kanban-wip-limits.desc",
      "Ticket per colonna e limiti WIP configurati",
    ),
  },
];
