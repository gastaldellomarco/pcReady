        ...
        <div className="rounded-lg border p-3" style={{ borderColor: "var(--border)" }}>
          <div className="grid gap-3 md:grid-cols-2">
            <label className="text-xs">
              <span className="pc-label">{t("maintenance.fieldTitle", "Titolo")}</span>
              <input
                className="pc-input mt-1 w-full"
                value={draft.title}
                onChange={(e) => setDraft((v) => ({ ...v, title: e.target.value }))}
                placeholder={t("maintenance.titlePlaceholder", "Pulizia hardware")}
              />
            </label>
            <label className="text-xs">
              <span className="pc-label">{t("maintenance.fieldRecurrence", "Ricorrenza")}</span>
              <select
                className="pc-input mt-1 w-full"
            ...
            <label className="text-xs">
              ...
              >
                <option value="">{t("maintenance.unassigned", "Non assegnato")}</option>
            ...
            <label className="text-xs md:col-span-2">
              <span className="pc-label">{t("maintenance.fieldDescription", "Descrizione")}</span>
              <textarea
            ...
            <label className="flex items-center gap-2 text-xs md:col-span-2">
              ...
              />
              {t("maintenance.fieldAutoTicket", "Crea automaticamente un ticket alla scadenza")}
            </label>
