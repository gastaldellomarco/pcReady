...
import { ClientSettingsPanel } from "@/components/clients/ClientSettingsPanel";
import { ClientTagBadges } from "@/components/clients/ClientTagBadges";
...
} from "@/components/clients/ClientPills";
import { SummaryBox } from "@/components/clients/helpers";
import { PortalLinkModal } from "@/components/clients/PortalLinkModal";
        ...
        <div className="space-y-3 border-b p-3" style={{ borderColor: "var(--border)" }}>
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              aria-label={t("filters.searchLabel", "Cerca clienti")}
              placeholder={t(
