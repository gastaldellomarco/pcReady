              ...
              <div className="flex items-center gap-2 px-1">
                ...
                <span
                  className={cn(
                    ...
                    isOverLimit ? "bg-red-100 text-red-700 border-red-200" : "text-text3 border-border",
                  )}
              ...
              >
                {items.map((c) => (
                  ...
                  >
                    ...
                    <div className="text-[12.5px] font-semibold mb-0.5">{c.device?.model || c.model || "Nessun asset"}</div>
                ...
                {!items.length && (
                  <div className="text-center py-6 text-[11px] text-text3 rounded-[7px]" style={{ border: "1.5px dashed var(--border2)" }}>
                    Trascina qui
                  </div>
                )}
              </div>
