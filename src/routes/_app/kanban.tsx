...
function KanbanPage() {
  ...
  useEffect(() => {
    supabase
      .from("tickets")
      .select(
        "id, ticket_code, client, model, status, priority, device:devices(model, serial), assignee:profiles!tickets_assignee_id_fkey(full_name, initials)",
      )
        ...
        return (
          ...
          >
            <div className="flex items-center gap-2 px-1">
              ...
              <span
                className="ml-auto text-[10px] font-mono text-text3 px-2 py-0.5 rounded-full"
